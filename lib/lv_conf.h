...
#define LV_USE_PERF_MONITOR 0 // 去掉调试信息
...
#define LVGL_FONT_SONG_16          0  /*Custom song font (使用与LVGL 8.3.7兼容的版本)*/
#define LVGL_FONT_YAHEI_16         1  /*Custom song font (使用与LVGL 8.3.7兼容的版本)*/
...
//#if LV_USE_PERF_MONITOR
//    /*Position of the performance monitor label*/
//    #define LV_USE_PERF_MONITOR_POS LV_ALIGN_BOTTOM_RIGHT
//#endif
